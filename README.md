...
* I saw fotball players data on kaggle. I thought it would be to create a model which make prediction on this. The Model predict player value(RMSE = 0.0049). I also have interest in football sport which motivates me to do this project.
